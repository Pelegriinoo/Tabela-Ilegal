// JavaScript para a tabela de preços e calculadora - Simplificado
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (calculadoraElementosExistem) {
        console.log("Inicializando a calculadora"); // Debug
        ...
        taxaBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                if (!usandoTaxaPersonalizada && !autoTaxaCheckbox.checked) {
                    ...
                    console.log("Taxa selecionada pelo botão:", taxaSelecionada); // Debug
        ...
        function calcularLavagem() {
            console.log("Calculando lavagem..."); // Debug
            ...
            if (autoTaxaCheckbox.checked) {
                ...
                console.log("Taxa automática:", taxa * 100 + "%"); // Debug
            } else {
                // Modo manual - taxa personalizada ou fixa
                if (usandoTaxaPersonalizada) {
                    taxa = parseInt(taxaPersonalizada.value) / 100;
                    console.log("Taxa personalizada:", taxa * 100 + "%"); // Debug
                } else {
                    ...
                    if (botaoAtivo) {
                        ...
                        console.log("Taxa do botão ativo:", taxa * 100 + "%"); // Debug
                    } else {
                        taxa = taxaSelecionada / 100;
                        console.log("Taxa selecionada (padrão):", taxa * 100 + "%"); // Debug
                    }
                }
            }
